...
describe Nervion::Request do
  ...
  context 'params' do
    ...
    it 'can be created with specific params' do
      params = { follow: '1,2,3' }
      request = described_class.new uri, params
  ...
  context 'oauth params' do
    ...
    it 'can be created with specific params' do
      oauth_params = { oauth_token: 'xxxxxxxxxxxxxxx' }
      request = described_class.new uri, {}, oauth_params
  ...
  context 'making requests' do
    ...
    it 'makes GET requests' do
      em_request.should_receive(:get).with(head: headers)
      subject.get
    end
    ...
    it 'makes POST requests' do
      ...
      em_request.should_receive(:post).with(head: headers, body: params)
      request.post
    end
  end
